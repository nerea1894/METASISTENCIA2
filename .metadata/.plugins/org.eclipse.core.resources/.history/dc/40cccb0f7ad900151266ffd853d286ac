...
public class PanelListaAlumnos extends JPanel implements ActionListener{
	...
	public PanelListaAlumnos(JFrame framePrincipal){
		...
		etiResultado.setFont(new Font("Century Gothic", Font.BOLD, 16));
		...
		etiResultado.setBounds(73, 305, 542, 18);
		...
		//se crea el lista y captura el elemento seleccionado en la lista
		...
		//Rellenar la lista con un arraylist
